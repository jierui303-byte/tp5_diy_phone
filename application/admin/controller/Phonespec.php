...
use app\admin\model\Index as Indexs;
use think\Request;
use think\Validate;
...
//        return $this->fetch('add');
    ...
    public function uploadPhoneTypePicture(Request $request)
    {
        ...
        $newLeavePath = ROOT_PATH . 'public' . DS . 'uploads' . DS . 'phoneSpec';//定义新的存储路径 /uploads/mask 蒙版目录下
        if ($file) {
...
//                echo $info->getFilename();
                $newPath = '/uploads' . DS . 'phoneSpec/' . $info->getSaveName();
